...
function page() {
  ...
  return (
    <div className='flex flex-col justify-center items-center bg-[url(../../public/musicSchool.jpeg)] h-screen bg-no-repeat bg-cover backdrop-brightness-50 bg-bottom'>
     ...
     <div className='my-4 flex flex-row justify-center items-center'> {/* Input fields of the form */}
      ...
      <div className='flex flex-col' >
       ...
       <input type="tel" pattern='[0-9]{3}-[0-9]{3}-[0-9]{4}' id='phone' placeholder='Enter your contact number' onChange={e=>setPhone(e.target.value)}  className='focus:outline-1 focus:outline-amber-300 rounded-2xl h-8 px-2 border-[0.25px] my-4' />
      </div>
     </div>
