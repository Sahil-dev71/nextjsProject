...
function Testinomial() {
  return (
    <div className="h-[30rem] w-full  relative flex flex-col items-center justify-center ">
         <div
        className={cn(
          "absolute inset-0",
      ...
      />
      <h2 className='text-3xl text-center font-bold mb-8 z-10'>Hear our Harmony: Voices of success</h2>
...
// classes { dark:bg-black dark:bg-grid-white/[0.2],overflow-hidden}